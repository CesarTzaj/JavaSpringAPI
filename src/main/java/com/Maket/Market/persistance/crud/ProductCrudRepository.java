...
public interface ProductCrudRepository extends CrudRepository<Product, Integer>{
    ...
    List<Product> findByCategoryIdOrderByNameDesc(int categoryId); //cuando se usa query methods se debe usar camel case example findByCategoryID el metodo+como se busca en la base de datos
